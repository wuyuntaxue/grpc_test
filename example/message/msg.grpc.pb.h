 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    virtual ::grpc::Status SayHelloAgain(::grpc::ClientContext* context, const ::HelloRequest& request, ::HelloReply* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::HelloReply>> AsyncSayHelloAgain(::grpc::ClientContext* context, const ::HelloRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::HelloReply>>(AsyncSayHelloAgainRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::HelloReply>> PrepareAsyncSayHelloAgain(::grpc::ClientContext* context, const ::HelloRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::HelloReply>>(PrepareAsyncSayHelloAgainRaw(context, request, cq));
    }
    class async_interface {
     public:
      ...
      virtual void SayHelloAgain(::grpc::ClientContext* context, const ::HelloRequest* request, ::HelloReply* response, std::function<void(::grpc::Status)>) = 0;
      virtual void SayHelloAgain(::grpc::ClientContext* context, const ::HelloRequest* request, ::HelloReply* response, ::grpc::ClientUnaryReactor* reactor) = 0;
    };
   ...
   private:
    ...
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::HelloReply>* AsyncSayHelloAgainRaw(::grpc::ClientContext* context, const ::HelloRequest& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::HelloReply>* PrepareAsyncSayHelloAgainRaw(::grpc::ClientContext* context, const ::HelloRequest& request, ::grpc::CompletionQueue* cq) = 0;
  };
  class Stub final : public StubInterface {
   public:
    ...
    ::grpc::Status SayHelloAgain(::grpc::ClientContext* context, const ::HelloRequest& request, ::HelloReply* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::HelloReply>> AsyncSayHelloAgain(::grpc::ClientContext* context, const ::HelloRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::HelloReply>>(AsyncSayHelloAgainRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::HelloReply>> PrepareAsyncSayHelloAgain(::grpc::ClientContext* context, const ::HelloRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::HelloReply>>(PrepareAsyncSayHelloAgainRaw(context, request, cq));
    }
    class async final :
     ...
     public:
      ...
      void SayHelloAgain(::grpc::ClientContext* context, const ::HelloRequest* request, ::HelloReply* response, std::function<void(::grpc::Status)>) override;
      void SayHelloAgain(::grpc::ClientContext* context, const ::HelloRequest* request, ::HelloReply* response, ::grpc::ClientUnaryReactor* reactor) override;
     private:
      friend class Stub;
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::HelloReply>* AsyncSayHelloAgainRaw(::grpc::ClientContext* context, const ::HelloRequest& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::HelloReply>* PrepareAsyncSayHelloAgainRaw(::grpc::ClientContext* context, const ::HelloRequest& request, ::grpc::CompletionQueue* cq) override;
  ...
  class Service : public ::grpc::Service {
   public:
    ...
    virtual ::grpc::Status SayHelloAgain(::grpc::ServerContext* context, const ::HelloRequest* request, ::HelloReply* response);
  };
  ...
  class WithAsyncMethod_SayHelloAgain : public BaseClass {
   ...
   public:
    ...
    void RequestSayHelloAgain(::grpc::ServerContext* context, ::HelloRequest* request, ::grpc::ServerAsyncResponseWriter< ::HelloReply>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
   ...
   public:
    WithCallbackMethod_SayHelloAgain() {
      ::grpc::Service::MarkMethodCallback(1,
          new ::grpc::internal::CallbackUnaryHandler< ::HelloRequest, ::HelloReply>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::HelloRequest* request, ::HelloReply* response) { return this->SayHelloAgain(context, request, response); }));}
  ...
  class WithStreamedUnaryMethod_SayHelloAgain : public BaseClass {
   ...
   public:
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status StreamedSayHelloAgain(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::HelloRequest,::HelloReply>* server_unary_streamer) = 0;
  };
